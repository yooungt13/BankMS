...
public class CheckBankReportServ extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			...
			// 创建响应输出，通过out将返回值写入response
		     ...
		     int bank_id = Integer.parseInt(req.getParameter("bank_id").trim());
		    ...
		    if( date.equals("") )
		    	out.write( logDao.findByBankId(bank_id).toString() ); 
		    else
		    	out.write( logDao.findByBankDate(bank_id, date_type,date).toString() );    	  
