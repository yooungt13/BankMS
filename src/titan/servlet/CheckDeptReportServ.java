...
public class CheckDeptReportServ extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			...
			// 创建响应输出，通过out将返回值写入response
		     ...
		     int dept_id = Integer.parseInt(req.getParameter("dept_id").trim());
		    ...
		    if( date.equals("") )
		    	out.write( logDao.findByDeptId(dept_id).toString() ); 
		    else
		    	out.write( logDao.findByDeptDate(dept_id, date_type,date).toString() );    	  
