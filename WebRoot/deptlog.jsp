...
<div id="content_main">
            	<div  id="content_left">
            		<div id="content_list">          		
            			...
            			<div   id="selected">Dept Report</div>
            			<% if( login.getType() > 1  ){ %>
            	...
            	<div  id="content_right"><form class="form">
            		<table style="margin:20px 0 0 30px;">
            			<tr>  				
            				<% if( login.getType() > 1 ){%>
            					<td>Dept ID:</td>
            					<td><input type="text" id="dept_id" style="width:80px;"/></td>
            					<td>
		            				<button type="button"  class="positive"  name="Confirm"  onclick="toCheckDeptReport();" style="margin-left:5px;margin-bottom:-10px;">Confirm</button>
		            			</td>
            				<%} %>				  
            				...
            				<td><input type="hidden"  id="dept_id" style="width:80px;" value="<%=login.getDepartment() %>"/></td>   	
            				<% if( login.getType() == 1 ){%>         
            				<td>
		            				<button type="button"  class="positive"  name="Confirm"  onclick="toCheckDeptReport();" style="margin-left:5px;margin-bottom:-10px;">Confirm</button>
		            		</td>
