...
<div id="content_main">
            	...
            	<div  id="content_right"><form class="form">
            		...
            		<button id="openCount" type="button" class="positive" name="Confirm" onclick="toSave();">Confirm</button>
            		<button type="button" class="positive" name="checkLog"  style="margin-left:45px;" onclick="toCheckLog(1);">Check Log</button>
