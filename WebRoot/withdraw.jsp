...
<head style="height:100%; overflow:hidden; margin:0px; padding:0px;">
    ...
    <link href="css/jquery-ui-1.8.16.custom.css" rel="stylesheet">
   	...
   	<script src="js/log_management.js" type="text/javascript" ></script>
...
<div id="content_main">
            	...
            	<div  id="content_right"><form class="form">
            		...
            		<button id="openCount" type="button" class="positive" name="Confirm" onclick="toWithdraw();">Confirm</button>
            		<button type="button" class="positive" name="checkLog"  style="margin-left:45px;" onclick="toCheckLog(2);">Check Log</button>
            		</form>
